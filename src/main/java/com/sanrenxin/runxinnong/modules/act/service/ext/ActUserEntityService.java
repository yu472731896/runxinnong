 ...
 * @润新农
 */
package com.sanrenxin.runxinnong.modules.act.service.ext;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new com.sanrenxin.runxinnong.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.sanrenxin.runxinnong.modules.sys.entity.User(null, userId)))){
