...
public class WxApi {
	...
	//获取模板消息列表
	private static final String GET_TEMPLATE_MESSAGE_LIST = "https://api.weixin.qq.com/cgi-bin/template/get_all_private_template?access_token=%s";
	...
	//获取粉丝列表接口
	public static String getTemplateMessageListUrl(String token){
		return String.format(GET_TEMPLATE_MESSAGE_LIST, token);
	}
	...
	public static JSONObject httpsRequest(String requestUrl, String requestMethod, String outputStr) {
		...
		try {
			...
			log.error("WxApi httpsRequest error:" + e.getMessage());
			e.printStackTrace();
		}
		return jsonObject;
	}
...
//	}
     ...
     */
    public static com.alibaba.fastjson.JSONObject addMateria(String accessToken,String type,String fileUrl,Map<String,String> params) throws WxErrorException {
