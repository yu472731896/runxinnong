...
//    }
    ...
    public static AjaxResult success() {
        ...
        result.setMsg(MessageUtil.MSG_SUCCESS);
        return result;
    }
    ...
    public static AjaxResult saveSuccess() {
        AjaxResult result = new AjaxResult();
        result.setSuccess(true);
        result.setMsg(MessageUtil.MSG_SUCCESS_SAVE);
        return result;
    }
    ...
    public static AjaxResult updateSuccess() {
        AjaxResult result = new AjaxResult();
        result.setSuccess(true);
        result.setMsg(MessageUtil.MSG_SUCCESS_UPDATE);
        return result;
    }
    ...
    public static AjaxResult deleteSuccess() {
        AjaxResult result = new AjaxResult();
        result.setSuccess(true);
        result.setMsg(MessageUtil.MSG_SUCCESS_DELETE);
        return result;
    }
