...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${ctxStatic}/chat/css/bootstrap.min.css">
    <link rel="stylesheet" type="text/css" href="${ctxStatic}/chat/css/guest.css?v=0.1">
...
<div data-role="page" id="main" style="overflow-y:auto;">
    <div data-role="content" class="container" role="main">
        <input type="hidden" id="mynickname" value="1111"/>
