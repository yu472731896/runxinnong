...
<body>
	<ul class="nav nav-tabs">
		...
		<li><a href="${ctx}/wx/wxMsgNews/selectList?multType=1">微信单图文消息表列表</a></li>
		<li><a href="${ctx}/wx/wxMsgNews/selectList?multType=2">微信多图文消息表列表</a></li>
	</ul>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="wxMsgText" varStatus="index">
			<tr onclick="checkforselect('${wxMsgText.id}','${wxMsgText.title }','${index.count }','${wxMsgText.baseId }')">
