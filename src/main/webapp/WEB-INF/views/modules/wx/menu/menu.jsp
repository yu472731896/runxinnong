...
<html>
<head>
    <link rel="stylesheet" href="${ctxStatic}/weixin/css/menu.css">
...
<script src="${ctxStatic}/pagination/pagination.js"></script>
...
<script src="${ctxStatic}/sortable/Sortable.min.js"></script>
...
//                            responselist[v.id]=v.title;
        ...
        function wxMenuInit() {
            ...
            var refreshkey = function (id,type) {
                $("input[name=key]").val(id).attr("data-msgtype", type).trigger("change");
            };
